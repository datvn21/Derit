...
export default function AdminSettings() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Content */}
      <main className="flex-1 max-w-4xl mx-auto px-8 w-full py-6 space-y-5">
        {/* General Settings */}
        <div className="bg-white rounded-lg border border-gray-200 p-5">
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="systemName" className="text-sm text-gray-700">System Name</Label>
              <Input
                id="systemName"
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <Label htmlFor="allowStudentReg" className="text-sm text-gray-700">Allow Student Registration</Label>
            </div>

            {formData.allowStudentRegistration && (
              <div className="mt-4">
                <Label htmlFor="studentDomains" className="text-sm text-gray-700">
                  Allowed Student Email Domains
                </Label>
                <p className="text-xs text-gray-500 mb-2">
                  Students can only register with emails from these domains. Enter one domain per line.
                </p>
                <textarea
                  id="studentDomains"
                  ...
                  rows={4}
                  className="mt-1.5 w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5">
          ...
          <div className="grid grid-cols-2 gap-5">
            <div>
              <Label htmlFor="compileTimeout" className="text-sm text-gray-700">Compile Timeout (ms)</Label>
              <Input
                id="compileTimeout"
                type="number"
            ...
            <div>
              <Label htmlFor="runTimeout" className="text-sm text-gray-700">Run Timeout (ms)</Label>
              <Input
                id="runTimeout"
                type="number"
            ...
            <div>
              <Label htmlFor="maxConcurrent" className="text-sm text-gray-700">Max Concurrent Submissions</Label>
              <Input
                id="maxConcurrent"
                type="number"
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5">
          ...
          <div className="grid grid-cols-2 gap-5">
            <div>
              <Label htmlFor="sessionExpiry" className="text-sm text-gray-700">Session Expiry (hours)</Label>
              <Input
                id="sessionExpiry"
                type="number"
            ...
            <div>
              <Label htmlFor="maxLoginAttempts" className="text-sm text-gray-700">Max Login Attempts</Label>
              <Input
                id="maxLoginAttempts"
                type="number"
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5">
          ...
          <div className="space-y-4">
            ...
            {formData.maintenanceMode && (
              <div>
                <Label htmlFor="maintenanceMessage" className="text-sm text-gray-700">
                  Maintenance Message
                </Label>
                <Input
